...
public class Bootstrap {
    ...
    private void initUsers() {
        ...
        usersToCreate.add(UserEntity.builder().name("Rabelo").role(Role.CUSTOMER)
            .avatarUrl(
                "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/User_with_smile.svg/1024px-User_with_smile.svg.png")
            .cpfCnpj("12312312312").password("blublu").email("rabelo@example.com").build());

        usersToCreate.add(UserEntity.builder().name("Carlos Alberto").role(Role.CUSTOMER)
            .avatarUrl("https://static.poder360.com.br/2020/12/Apple-868x644.jpg")
